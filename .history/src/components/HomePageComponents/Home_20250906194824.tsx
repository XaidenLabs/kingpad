...
import ModernSearchHeader from '../HomePageComponents/ModernSearchHeader'
...
const HomeComnponent = () => {
    ...
    return (
        ...
        <div>
            ...
            <ModernSearchHeader seacrhTerm={seacrhTerm} searchHandler={searchHandler} tabState={tabState} allCoinsHandler={allCoinsHandler} metaVerseCategrotyHandler={metaVerseCategrotyHandler} gamingCoinsCategoryHandler={gamingCoinsCategoryHandler} onOpen={onOpen} currencyModalToggle={currencyModalToggle} currencyModal={currencyModal} setCurrency={setCurrency} currency={currency} />
