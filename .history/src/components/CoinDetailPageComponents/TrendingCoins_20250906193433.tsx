  ...
  const CoinCard = memo(({ item, index }: { item: topCoinObj; index: number }) => {
    ...
    return (
      ...
      >
        ...
        {/* Main card */}
        <div className="relative w-[1200vh] bg-gray-900/95 backdrop-blur-xl rounded-2xl border border-gray-800/50 p-6 h-64 flex flex-col justify-between overflow-hidden">
          {/* Background pattern */}
